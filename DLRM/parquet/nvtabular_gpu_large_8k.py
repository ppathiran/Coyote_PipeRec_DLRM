...
train_file = "/mnt/scratch/yuzhuyu/parquet/pseudo_dataset_504_dense_42_sparse.parquet"
# train_file = "/home/yuzhuyu/parquet/pseudo_dataset_504_dense_42_sparse.parquet"

# Define column groups
CRITEO_CONTINUOUS_COLUMNS = [f'col_{x}' for x in range(1, 505)]
CRITEO_CATEGORICAL_COLUMNS = [f'col_{x}' for x in range(505, 547)]
