...
def generate_pseudo_parquet_with_fixed_length(output_parquet, num_rows=45840617, target_column='col_0', num_dense=13, num_sparse=26):
...
# Example usage
output_parquet_path = "/mnt/scratch/yuzhuyu/parquet/bin2parquet_fixed_length.parquet"
